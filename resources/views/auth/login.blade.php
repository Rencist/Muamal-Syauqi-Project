    ...
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        ...
        <div class="w-full bg-white rosunded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" method="POST" action="{{ route('login') }}" validate>
                    <div>
                    ...
                    <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                        Doesn`t have an account? <a href="{{ url('/create_user') }}" class="font-medium text-blue-600 hover:underline dark:text-blue-500">Create here</a>
                    </p>
                </form>
            </div>
        </div>
