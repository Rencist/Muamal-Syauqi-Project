    ...
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        <div class="w-full bg-white rosunded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-200 dark:border-gray-200">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                <h1 class="text-center text-xl font-bold leading-tight tracking-tight text-gray-900 md:text-2xl dark:text-gray-800">
                    Kamu telah membeli 
                </h1>

                <div class="border-b-2 border-gray-800">
                    <h1 class=" text-center text-xl font-bold leading-tight tracking-tight text-green-800 md:text-2xl dark:text-gray-800">
                        {{ $data['name'] }}
                    </h1>
                </div>
